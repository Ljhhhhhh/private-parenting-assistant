...
- **按钮**：
  ...
  - 文字：白色，居中
  - 阴影：`shadow-[#4A90E2]/20`
  - 悬停状态：更深阴影 `hover:shadow-[#4A90E2]/30`
...
- **提示和链接**：
  - 尺寸：14px
  - 错误提示：使用错误色 `text-[#FF5252]`

#### 16.1.4 间距规范

- **整体页面**：上边距 48px，水平外边距 16px
- **表单内部**：垂直间距 24px
- **标签与输入框**：垂直间距 8px
...
- 登录与注册页面应保持一致的视觉风格
- 使用同样的背景渐变、卡片样式和表单元素设计
- 主操作按钮统一使用主色渐变 `from-[#4A90E2] to-[#7AADEE]`
- 页面切换链接（登录/注册）使用相同的位置和样式
